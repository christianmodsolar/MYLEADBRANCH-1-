  ...
  public void testGood() throws Exception {
    ...
    .perform();
	 ...
	 Thread.sleep(8000);
	  ...
	  //Enter Price Per watt
	  driver.findElement(By.id("pricePerWatt")).clear();
	  driver.findElement(By.id("pricePerWatt")).sendKeys("0.80");
	  
	  driver.findElement(By.id("selectedProgramCheckbox_200")).click();
	  Thread.sleep(8000);
	  ...
	  driver.findElement(By.id("fid_200")).click();
