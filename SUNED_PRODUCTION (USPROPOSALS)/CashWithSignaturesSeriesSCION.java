...
public class CashWithSignaturesSeriesSCION {
  ...
  public void testGood() throws Exception {
    ...
    driver.findElement(By.id("firstNameResidential")).sendKeys("AUTOMATIONRELEASEAUG08");
    driver.findElement(By.id("lastNameResidential")).clear();
    driver.findElement(By.id("lastNameResidential")).sendKeys("AUTOMATIONRELEASEAUG08");
    ...
    .perform();
	 ...
	 Thread.sleep(8000);
	  ...
	  driver.findElement(By.id("selectedProgramCheckbox_175")).click();
	  Thread.sleep(8000);
	  ...
	  //click on CashwithSignature Series
	  driver.findElement(By.id("fid_175")).click();
