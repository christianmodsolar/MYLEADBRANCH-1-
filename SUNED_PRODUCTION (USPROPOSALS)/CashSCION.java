...
public class CashSCION {
  ...
  public void test1() throws Exception {
    ...
    driver.findElement(By.id("firstNameResidential")).sendKeys("AutomationReleaseSEP03-SCION");
    driver.findElement(By.id("lastNameResidential")).clear();
    driver.findElement(By.id("lastNameResidential")).sendKeys("AutomationReleaseSEP03-SCION");
